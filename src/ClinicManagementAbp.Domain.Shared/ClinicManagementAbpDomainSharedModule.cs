...
public class ClinicManagementAbpDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ClinicManagementAbpGlobalFeatureConfigurator.Configure();
        ClinicManagementAbpModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ClinicManagementAbpDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ClinicManagementAbpResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ClinicManagementAbp");

            options.DefaultResourceType = typeof(ClinicManagementAbpResource);
        ...
        {
            options.MapCodeNamespace("ClinicManagementAbp", typeof(ClinicManagementAbpResource));
        });
    }
}
