...
{
    [DbContext(typeof(ClinicManagementAbpDbContext))]
    [Migration("20251216164345_InitialClinicEntities")]
    partial class InitialClinicEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicManagementAbp.Appointments.Appointment", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("ClinicManagementAbp.DoctorSchedules.DoctorSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicManagementAbp.Doctors.Doctor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicManagementAbp.Patients.Patient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicManagementAbp.Appointments.Appointment", b =>
                {
                    b.HasOne("ClinicManagementAbp.Doctors.Doctor", "Doctor")
                        .WithMany("Appointments")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClinicManagementAbp.Patients.Patient", "Patient")
                        .WithMany("Appointments")
