...
public class ClinicManagementAbpDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ClinicManagementAbpDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
